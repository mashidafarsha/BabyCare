...
import { getApprovedDoctor,getAllUserData,getPlans } from "../../sevices/adminApi";
          ...
          <div className="">
            ...
            {/* <div className="flex flex-col items-center justify-center pt-5 uppercase md:flex-row md:justify-around">
                ...
                <div
                  ...
                  className="flex flex-col justify-center p-5 my-3 text-center bg-gray-200 w-72 h-28 md:w-72 md:h-32 rounded-xl"
                >
