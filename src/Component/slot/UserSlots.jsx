...
import { getUserBookedSlot } from "../../sevices/userApi";
function UserSlots() {
  ...
  useEffect(() => {
    console.log(doctorData,"jjjj");
    setDoctorSlot(doctorData.slots);
    setDoctorId(doctorData._id)
    getBookedSlot()
  }, []);
console.log(show,"jjjj");
  const dates = [];
  for (let i = 1; i < 11; i++) {
  ...
  return (
    ...
    <div className={show ? 'block' : 'hidden'}>
      <SlotBookingAddress doctorData={doctorData} userSelectTime={userSelectTime} />
      </div>
    </>
  );
}
